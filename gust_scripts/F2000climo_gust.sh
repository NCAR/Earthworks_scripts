...
for NTASKS in ${NTASKSS[@]:-"-1"}; do
  ...
  case $RES in
    ...
    60)
      ...
      ATM_SRF="/glade/work/ssuresh/ucsu0085/inputdata/atmsrf_mpasa60_c210511.nc"
      ATM_NCDATA="/glade/work/ssuresh/ucsu0085/inputdata/cami_01-01-2000_00Z_mpasa60_L32_CFSR_c210518.nc"
      ATM_BND="/glade/work/ssuresh/ucsu0085/inputdata/mpas_60_nc3000_Co030_Fi001_MulG_PF_Nsw021.nc"
      ;;
    30)
      ATM_BLCK_PRE="/glade/work/ssuresh/mpas_resources/meshes/x1.655362_mesh/x1.655362.graph.info.part."
      ATM_SRF="/glade/work/ssuresh/ucsu0085/inputdata/atmsrf_mpasa30_c210601.nc"
      ATM_NCDATA="/glade/work/ssuresh/ucsu0085/inputdata/cami_01-01-2000_00Z_mpasa30_L32_CFSR_c220624.nc"
      ATM_BND="/glade/work/ssuresh/ucsu0085/inputdata/mpas_30_nc3000_Co015_Fi001_MulG_PF_Nsw011.nc"
      ;;
    *)
  ...
  if [ "$DO_CREATE" = true ]; then
    ...
    #./xmlchange LND_DOMAIN_FILE="domain.lnd.mpasa0600_gx1v7.201215.nc"

cat << __EOF_NL_CAM >> user_nl_cam
!ncdata = '$ATM_NCDATA'
!drydep_srf_file = '$ATM_SRF'
!bnd_topo = '$ATM_BND'
...
&camexp
 fsurdat = '/glade/gust/p/cesmdata/inputdata/lnd/clm2/surfdata_map/release-clm5.0.34/surfdata_mpasa120_hist_78pfts_CMIP6_simyr2000_c201215.nc'
/
__EOF_NL_CLM

 #fsurdat = '/glade/gust/p/cesmdata/inputdata/lnd/clm2/surfdata_map/release-clm5.0.34/surfdata_mpasa120_hist_78pfts_CMIP6_simyr2000_c201215.nc'
 #fsurdat = '/glade/work/ssuresh/ucsu0085/inputdata/surfdata_mpasa60_hist_78pfts_CMIP6_simyr2000_c211110.nc'
