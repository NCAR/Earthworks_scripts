#!/usr/bin/env bash
THIS_FILE="FullyCoupled_gust.sh"
...
for NTASKS in ${NTASKSS[@]:-"-1"}; do
  ...
  case $RES in
    120)
      ATM_DMN_MESH="/glade/gust/p/cesmdata/inputdata/atm/cam/coords/mpasa120_ESMF_desc.200911.nc"
      ATM_BLCK_PRE="/glade/work/ssuresh/mpas_resources/meshes/x1.40962_mesh/x1.40962.graph.info.part."
      ATM_NCDATA="/glade/work/ssuresh/ucsu0085/inputdata/cami_01-01-2000_00Z_mpasa120_L32_CFSR_c210426.nc"
      ATM_SRF=""
      ATM_BND=""
      OCN_BLCK_PRE="/glade/work/ssuresh/ucsu0085/inputdata/mpas-o.graph.info.QU120.part."
      LND_DMN_MESH="/glade/p/cesmdata/cseg/inputdata/atm/cam/coords/mpasa120_ESMF_desc.200911.nc"
      LND_FSUR="/glade/gust/p/cesmdata/inputdata/lnd/clm2/surfdata_map/surfdata_mpasa120_hist_78pfts_CMIP6_simyr2000_c211108.nc"
      ...
      ;;
    60)
      ATM_DMN_MESH="/glade/gust/p/cesmdata/inputdata/share/meshes/mpasa60_ESMFmesh-20210803.nc"
      ATM_BLCK_PRE="/glade/work/ssuresh/mpas_resources/meshes/x1.163842_mesh/x1.163842.graph.info.part."
      ATM_NCDATA="/glade/work/ssuresh/ucsu0085/inputdata/cami_01-01-2000_00Z_mpasa60_L32_CFSR_c210518.nc"
      ATM_SRF="/glade/gust/p/cesmdata/inputdata/atm/cam/chem/trop_mam/atmsrf_mpasa60_c210601.nc"
      ATM_BND="/glade/gust/p/cesmdata/inputdata/atm/cam/topo/mpas_60_nc3000_Co030_Fi001_MulG_PF_Nsw021.nc"
      LND_DMN_MESH="/glade/gust/p/cesmdata/inputdata/share/meshes/mpasa60_ESMFmesh-20210803.nc"
      LND_FSUR="/glade/gust/p/cesmdata/inputdata/lnd/clm2/surfdata_map/surfdata_mpasa60_hist_78pfts_CMIP6_simyr2000_c211110.nc"
      ...
      ;;
    30)
      ATM_DMN_MESH="/glade/gust/p/cesmdata/inputdata/share/meshes/mpasa30_ESMFmesh-20210803.nc"
      ATM_BLCK_PRE="/glade/work/ssuresh/mpas_resources/meshes/x1.655362_mesh/x1.655362.graph.info.part."
      ATM_NCDTA="/glade/gust/p/cesmdata/inputdata/atm/cam/inic/mpas/mpasa30_L32_CFSR_c210611.nc"
      ATM_SRF="/glade/gust/p/cesmdata/inputdata/atm/cam/chem/trop_mam/atmsrf_mpasa30_c210511.nc"
      ATM_BND="/glade/gust/p/cesmdata/inputdata/atm/cam/topo/mpas_30_nc3000_Co015_Fi001_MulG_PF_Nsw011.nc"
      LND_DMN_MESH="/glade/gust/p/cesmdata/inputdata/share/meshes/mpasa30_ESMFmesh-20210803.nc"
      LND_FSUR="/glade/gust/p/cesmdata/inputdata/lnd/clm2/surfdata_map/surfdata_mpasa30_hist_78pfts_CMIP6_simyr2000_c211111.nc"
  ...
  if [ "$DO_CREATE" = true ]; then
    ...
    # Define mesh files
    ./xmlchange OCN_DOMAIN_MESH="/glade/work/ssuresh/ucsu0085/inputdata/oQU${RES}_ESMFmesh.nc"
    ./xmlchange ICE_DOMAIN_MESH="/glade/work/ssuresh/ucsu0085/inputdata/oQU${RES}_ESMFmesh.nc"
    ./xmlchange MASK_MESH="/glade/work/ssuresh/ucsu0085/inputdata/oQU${RES}_ESMFmesh.nc"
    ...
    RST_DIR="$(printf '/glade/work/ssuresh/ucsu0085/rst_aos_%03dkm' ${RES})"
...
&decomposition
 config_block_decomp_file_prefix = '/glade/work/ssuresh/ucsu0085/inputdata/mpas-o.graph.info.QU${RES}.part.'
